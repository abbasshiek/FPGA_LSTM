...
entity lstm_function_lstm_function_Pipeline_VITIS_LOOP_104_6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of lstm_function_lstm_function_Pipeline_VITIS_LOOP_104_6 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln104_fu_115_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln23_fu_167_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal select_ln23_reg_206 : STD_LOGIC_VECTOR (11 downto 0);
    signal zext_ln104_fu_127_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal i_fu_62 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal add_ln104_fu_121_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_1 : STD_LOGIC_VECTOR (5 downto 0);
    signal intermediate_ce0_local : STD_LOGIC;
    signal sext_ln8_cast_fu_103_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln23_fu_141_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln24_fu_147_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln23_fu_161_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln23_1_fu_153_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln22_fu_137_p1 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln104_fu_115_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    add_ln104_fu_121_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv6_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln104_fu_115_p2)
    begin
        if (((icmp_ln104_fu_115_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln104_fu_115_p2 <= "1" when (ap_sig_allocacmp_i_1 = sext_ln8_cast_fu_103_p1) else "0";
    icmp_ln23_fu_141_p2 <= "1" when (signed(intermediate_q0) > signed(ap_const_lv16_400)) else "0";
    icmp_ln24_fu_147_p2 <= "1" when (signed(intermediate_q0) < signed(ap_const_lv16_FC00)) else "0";
    intermediate_address0 <= zext_ln104_fu_127_p1(8 - 1 downto 0);
    intermediate_ce0 <= intermediate_ce0_local;

    intermediate_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_gmem_0_RREADY <= ap_const_logic_0;
        m_axi_gmem_0_WDATA <= std_logic_vector(IEEE.numeric_std.resize(signed(select_ln23_reg_206),16));
    ...
    or_ln23_fu_161_p2 <= (icmp_ln24_fu_147_p2 or icmp_ln23_fu_141_p2);
    select_ln23_1_fu_153_p3 <= 
        ap_const_lv12_100 when (icmp_ln23_fu_141_p2(0) = '1') else 
        ap_const_lv12_F00;
    select_ln23_fu_167_p3 <= 
        select_ln23_1_fu_153_p3 when (or_ln23_fu_161_p2(0) = '1') else 
        trunc_ln22_fu_137_p1;
        sext_ln8_cast_fu_103_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln8),6));

    trunc_ln22_fu_137_p1 <= intermediate_q0(12 - 1 downto 0);
    zext_ln104_fu_127_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
end behav;
