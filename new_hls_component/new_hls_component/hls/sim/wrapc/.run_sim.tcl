...
# 
# ==============================================================
set ::env(PATH) "D:/xilinx/Vitis/2024.2/win64/tools/fpo_v7_1;$::env(Path)"
set ::env(PATH) "D:/xilinx/Vitis/2024.2/win64/tools/fft_v9_1;$::env(Path)"
set ::env(PATH) "D:/xilinx/Vitis/2024.2/win64/tools/fir_v7_0;$::env(Path)"
set ::env(PATH) "D:/xilinx/Vitis/2024.2/win64/tools/dds_v6_0;$::env(Path)"
set ::env(PATH) "D:/xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt/bin;$::env(Path)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lstm_function.autotvin.dat"
	set constFileTvOut       "lstm_function.autotvout.dat"
	set constFileHdlTvIn     "lstm_function.autohdltvin.dat"
	set constFileHdlTvOut    "lstm_function.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
