...
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := D:/xilinx/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --sysroot=D:/xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
...
LFLAG += -lpthread
LFLAG += -L D:/xilinx/Vitis/2024.2/vcxx/lib/clang/14.0.6/lib/windows -lclang_rt.builtins-x86_64
...
$(ObjDir)/lstm_tb.cpp_pre.cpp.tb.o : lstm_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling lstm_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/activation_LUT.cpp_pre.cpp.tb.o : activation_LUT.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling activation_LUT.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/block_circulant.cpp_pre.cpp.tb.o : block_circulant.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling block_circulant.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/updated_weights.cpp_pre.cpp.tb.o : updated_weights.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling updated_weights.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lstm_new.cpp_pre.cpp.tb.o : lstm_new.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling lstm_new.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
