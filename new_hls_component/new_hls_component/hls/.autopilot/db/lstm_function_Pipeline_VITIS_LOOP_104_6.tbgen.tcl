set moduleName lstm_function_Pipeline_VITIS_LOOP_104_6
set isTopModule 0
...
set cdfgNum 9
set C_modelName {lstm_function_Pipeline_VITIS_LOOP_104_6}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict intermediate { MEM_WIDTH 16 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 16 regular {axi_master 1}  }
	{ sext_ln8 int 5 regular  }
	{ sext_ln104 int 63 regular  }
	{ intermediate int 16 regular {array 256 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control_r"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln8", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln104", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "intermediate", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln8 sc_in sc_lv 5 signal 1 } 
	{ sext_ln104 sc_in sc_lv 63 signal 2 } 
	{ intermediate_address0 sc_out sc_lv 8 signal 3 } 
	{ intermediate_ce0 sc_out sc_logic 1 signal 3 } 
	{ intermediate_q0 sc_in sc_lv 16 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln8", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "sext_ln8", "role": "default" }} , 
 	{ "name": "sext_ln104", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln104", "role": "default" }} , 
 	{ "name": "intermediate_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "intermediate", "role": "address0" }} , 
 	{ "name": "intermediate_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "intermediate", "role": "ce0" }} , 
 	{ "name": "intermediate_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "intermediate", "role": "q0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "13", "Max" : "65"}
	, {"Name" : "Interval", "Min" : "13", "Max" : "65"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln8 { ap_none {  { sext_ln8 in_data 0 5 } } }
	sext_ln104 { ap_none {  { sext_ln104 in_data 0 63 } } }
	intermediate { ap_memory {  { intermediate_address0 mem_address 1 8 }  { intermediate_ce0 mem_ce 1 1 }  { intermediate_q0 mem_dout 0 16 } } }
}
