...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename intermediate \
    op interface \
    ports { intermediate_address0 { O 8 vector } intermediate_ce0 { O 1 bit } intermediate_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'intermediate'"
}
}
